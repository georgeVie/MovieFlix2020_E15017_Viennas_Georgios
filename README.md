...
* ### Εισαγωγή νέας ταινίας στο MovieFlix http://localhost:5000/admin
    Στον πίνακα ελέγχου υπάρχει μια φορά με το όνομα **Προσθήκη/Ενημέρωση ταινίας** . Εκεί ο διαχειριστής μπορεί να εισάγει τα στοιχεία της νέας ταινίας σε μορφή **JSON** και να κάνει κλικ στο κουμπί **Προσθήκη** για καταχωρηθεί η  ταινία στο σύστημα. Απαραίτητα για της εισαγωγή μιας νέας ταινίας είναι ο τίτλος της ταινίας (title) και τουλάχιστον ένας πρωταγωνιστής (actor). Αν δεν υπάρχουν εμφανίζεται σχετικό μήνυμα. Τα δεδομένα που θα εισαχθούν πρέπει να ακολουθούν την εξής μορφή:
    ```json
    {
        "title": "MovieTitle",
        "year": 0000,
...
* ### Ενημέρωση υπάρχουσας ταινίας http://localhost:5000/admin
    Στον πίνακα ελέγχου υπάρχει μια φορά με το όνομα **Προσθήκη/Ενημέρωση ταινίας** . Εκεί ο διαχειριστής μπορεί να εισάγει τα στοιχεία της ταινίας που θελει να ενημερώσει σε μορφή **JSON** και να κάνει κλικ στο κουμπί **Ενημέρωση** για ενημερώθει η  ταινία στο σύστημα. Απαραίτητα για την ενημέρωση της ταινίας είναι ο τίτλος της ταινίας που θέλουμε να ενημερωθεί (current-title). Τα δεδομένα που θα εισαχθούν πρέπει να ακολουθούν την εξής μορφή:
    ```json
    {
